...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSArray *sideMenuItemsClass = @[@"DemoSideMenuOne",
                          @"DemoSideMenuTwo",
                          @"DemoSideMenuThree",
                          @"DemoSideMenuFour"
                          ];
    
    NSArray *sideMenuTitles = @[@"Item1",
                                @"Item2",
                                @"Item3",
                                @"Item4",
                                ];
    
    self.window.rootViewController = [controller createAppWithSideMenuItemsTitle:sideMenuTitles
                                                            andSideMenuItemClass:sideMenuItemsClass
